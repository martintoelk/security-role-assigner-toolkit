...
describe("PPTB package manifest", () => {
    it("declares the approved public tool identity", () => {
        ...
        expect(manifest.homepage).toBe("https://github.com/martintoelk/security-role-assigner-toolkit");
        expect(manifest.readme).toBe("https://raw.githubusercontent.com/martintoelk/security-role-assigner-toolkit/master/README.md");
